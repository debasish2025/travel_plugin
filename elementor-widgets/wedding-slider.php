...
class Elementor_Wedding_Slider_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'wedyara_wedding_slider';
    }

    public function get_title() {
        return 'Wedyara - Wedding Slider';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'categories',
            [
                'label' => 'Select Wedding Categories',
    ...
    private function get_package_categories() {
        ...
        error_log('===== WEDYARA WEDDING SLIDER DEBUG: get_package_categories =====');
    ...
    protected function render() {
        ...
        error_log('===== WEDYARA WEDDING SLIDER DEBUG: RENDER =====');

...
class Elementor_Wedding_Grid_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'wedyara_wedding_grid';
    }

    public function get_title() {
        return 'Wedyara - Wedding Grid';
    }
    ...
    private function get_package_categories() {
        ...
        error_log('===== WEDYARA WEDDING GRID DEBUG: get_package_categories =====');
    ...
    protected function render() {
        ...
        error_log('===== WEDYARA WEDDING GRID DEBUG: RENDER =====');

...
class Elementor_Destination_Carousel_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        // Travel Categories (only shown when package_type is travel_package)
        $this->add_control(
            'travel_categories',
            [
        ...
        // Wedding Categories (only shown when package_type is wedding_package)
        $this->add_control(
            'wedding_categories',
            [
                'label' => 'Select Categories',
        ...
        // Travel Regions (only shown when package_type is travel_package)
        $this->add_control(
            'travel_regions',
            [
        ...
        // Wedding Regions (only shown when package_type is wedding_package)
        $this->add_control(
            'wedding_regions',
            [
                'label' => 'Select Regions',
    ...
    private function get_travel_categories() {
        $categories = get_terms(array(
            ...
            'hide_empty' => true, // Hide categories with no packages
        ));
    ...
    private function get_travel_regions() {
        $regions = get_terms(array(
            'taxonomy' => 'tpm_region',
            'hide_empty' => true, // Hide regions with no packages
        ));
    ...
    protected function render() {
        ...
        if (is_wp_error($query)) {
            error_log('WEDYARA ERROR: Carousel query failed - ' . $query->get_error_message());
        }

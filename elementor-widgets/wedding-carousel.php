...
class Elementor_Wedding_Carousel_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'wedyara_wedding_carousel';
    }

    public function get_title() {
        return 'Wedyara - Wedding Carousel';
    }
    ...
    private function get_package_categories() {
        ...
        error_log('===== WEDYARA WEDDING DEBUG: get_package_categories =====');
    ...
    protected function render() {
        ...
        error_log('===== WEDYARA WEDDING DEBUG: RENDER =====');
